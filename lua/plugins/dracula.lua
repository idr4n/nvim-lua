  ...
  config = function()
    ...
    dracula.setup({
      ...
      overrides = {
        ...
        MiniTablineVisible = { fg = c.magenta, bg = c.bg_lighter },
        MiniTablineHidden = { fg = c.comment, bg = c.bg_lighter },
        MiniTablineModifiedCurrent = { fg = c.yellow, bg = c.bg_lighter },
        MiniTablineModifiedHidden = { fg = c.yellow, bg = c.bg_lighter },
        MiniTablineModifiedVisible = { fg = c.yellow, bg = c.bg_lighter },
      },
    })
  end,
}
