...
if vim.g.colors_name == "noirbuddy" then
  ...
  Group.new("illuminatedWord", nil, colors.noir_8, nil)
  Group.new("illuminatedCurWord", nil, colors.noir_8, nil)
  Group.new("IlluminatedWordText", nil, colors.noir_8, nil)
  Group.new("IlluminatedWordRead", nil, colors.noir_8, nil)
  Group.new("IlluminatedWordWrite", nil, colors.noir_8, nil)
